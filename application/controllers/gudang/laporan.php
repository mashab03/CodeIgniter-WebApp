...
class Laporan extends CI_Controller {
	...
	function repbelitanggal()
	{
		...
		{
			$this->load->library('database_library');
		$select=("pembelian_detail.id_transaksi, pembelian_detail.tanggal, obat.nama_obat, pembelian_detail.qty, pembelian_detail.harga_beli, pembelian_detail.harga_jual, pembelian_detail.nomorPO, supplier.nama_supplier");	
		$from=("(pembelian_detail LEFT JOIN supplier ON pembelian_detail.id_supplier = supplier.id_supplier) LEFT JOIN obat ON pembelian_detail.id_obat = obat.id_obat");
	...
	function repsisastok()
	{
		...
		$from="(obat LEFT JOIN kategori_obat ON obat.id_kategori_obat = kategori_obat.id_kategori_obat) LEFT JOIN satuan_obat ON obat.id_satuan_obat = satuan_obat.id_satuan_obat order by obat.nama_obat asc";
