...
$att=array(
	...
	echo form_open('gudang/returns/go',$att);
?>
<?php foreach($isinfo as $r) { ?>
<div class="control-group">
<label class="control-label" for="inputEmail">No. Amprah</label>
<div class="controls">
<input type="text" id="inputEmail" name="nomor" value="<?=$r->id_amprah;?>" readonly data-validation="length" data-validation-length="min3">

</div>
</div>
<input type="hidden" name="koderuang" value="<?=$r->id_ruangan;?>" />
<div class="control-group">
<label class="control-label" for="inputEmail">Nama Ruangan</label>
<div class="controls">
<input type="text" id="inputEmail" name="ruang" value="<?=$r->nama_ruangan;?>" readonly data-validation="length" data-validation-length="min3">
</div>
</div>
<div class="control-group">
