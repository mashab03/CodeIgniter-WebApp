...
echo form_open('gudang/ruangan/update?uid='.$id.'',$att);
?>
   <div class="control-group">
<label class="control-label" for="inputEmail">Nama Ruangan</label>
<div class="controls">
<input type="text" id="inputEmail" name="nama" value="<?=$nama;?>" placeholder="Nama Ruangan" data-validation="length" data-validation-length="min3">
</div>
</div>
<div class="control-group">
<div class="controls">
